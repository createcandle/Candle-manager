 ...
 * 
 * You can use it indoor or outdoor. It can also predict the weather indoors.
 * 
...
#define MY_ENCRYPTION_SIMPLE_PASSWD "test2"    // This is the password used to encrypt and sign the wireless communication.
...
#define INTERVAL 1000                               // When active, the main check occurs every 100 milliseconds, which is one tenth of a second.
